            ...
            <div class="jumlah-user flex flex-row gap-x-6 ">
                ...
                <div
                    ...
                    <div class="total">
                        ...
                        <p class="angka-siswa font-extrabold text-xl text-fontColor">865</p>
                    </div>
                    <div class="laki">
                        <p class="total-siswa-lelaki text-xs font-medium opacity-80">Laki Laki</p>
                        <p class="angka-siswa-lelaki font-extrabold text-xl text-fontColor">492</p>
                    </div>
                    <div class="perempuan mb-4">
                        <p class="total-siswa-perempuan text-xs font-medium opacity-80">Perempuan</p>
                        <p class="angka-siswa-perempuan font-extrabold text-xl text-fontColor">373</p>
                    </div>
                    <div
                ...
                <div
                    ...
                    <div class="total">
                        ...
                        <p class="angka-Guru font-extrabold text-xl text-fontColor">89</p>
                    </div>
                    <div class="laki">
                        <p class="total-Guru-lelaki text-xs font-medium opacity-80">Laki Laki</p>
                        <p class="angka-Guru-lelaki font-extrabold text-xl text-fontColor">59</p>
                    </div>
                    <div class="perempuan mb-4">
                        <p class="total-Guru-perempuan text-xs font-medium opacity-80">Perempuan</p>
                        <p class="angka-Guru-perempuan font-extrabold text-xl text-fontColor">30</p>
                    </div>
                    <div
                        class="footer absolute bottom-0 w-full text-sm font-semibold bg-gray rounded-b-xl text-white p-1">
                        <p>Data Guru</p>
                    ...
                    <div class="container text-center">
                        <div class="text flex-row flex mb-4 divide-x-2 text-divColor ">
                            <div class="siswa w-full">
                                ...
                                <p class="angka-siswa font-extrabold text-xl text-fontColor">12</p>
                            </div>
                            <div class="guru w-full">
                                <p class="judul text-xs font-medium text-gray opacity-80">Guru</p>
                                <p class="angka-guru font-extrabold text-xl text-fontColor">4</p>
                            </div>
                        </div>
                    </div>
                    <div
