            ...
            <ul class="nav px-2 mt-3 nav-pills flex-column mb-auto text-sm font-semibold">
                <li class="nav-item">
                    ...
                    <a href="{{ route('dashboard.index') }}"
                        class="nav-link link-dark gap-x-10 flex flex-row  {{ Request::is('/')
                            ? "
                ...
                <a href="{{ route('dashboard.profile') }}"
                    class="nav-link link-dark gap-x-10 flex flex-row  {{ Request::is('profile*')
                        ? " bg-white drop-shadow-shadowAdi
                          text-fontColor"
                        : '' }}">
                    <span class="material-symbols-rounded">
                        person
                ...
                <li>
                    <a href="{{ route('dashboard.attendances') }}"
                        class="nav-link link-dark gap-x-10 flex flex-row  {{ Request::is('attendances')
                            ? " bg-white
            ...
            <ul class="nav px-2 mt-3 nav-pills flex-column mb-auto text-sm font-semibold">
                <li class="nav-item">
                    <a href="{{ route('dashboard.admin') }}"
                        class="nav-link link-dark gap-x-10 flex flex-row{{ Request::is('dashboard-admin')
                            ? " bg-white
                                drop-shadow-shadowAdi text-fontColor"
                            : '' }}">
                        <span class="material-symbols-rounded">
                ...
                <a href=" {{ route('dashboard.student') }}"
                    class="nav-link link-dark gap-x-10 flex flex-row{{ Request::is('student*')
                        ? " bg-white drop-shadow-shadowAdi
                          text-fontColor"
                        : '' }}">
                    <span class="material-symbols-rounded">
                ...
                <li>
                    <a href="{{ route('dashboard.teacher') }}"
                        class="nav-link link-dark gap-x-10 flex flex-row  {{ Request::is('teacher*')
                            ? " bg-white drop-shadow-shadowAdi
                                text-fontColor"
                            : '' }}">
                        <span class="material-symbols-rounded">
...
<div class="drawer drawer-mobile hidden lg:grid">
    <input id="my-drawer" type="checkbox" class="drawer-toggle" />
    <div class="drawer-side max-md:hidden ">
